                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('sku_induk') is-invalid @enderror"
                                        id="sku_induk" name="sku_induk"
                                        value="{{ old('sku_induk', $produk->sku_induk) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nomor_referensi_sku', $produk->nomor_referensi_sku) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_variasi') is-invalid @enderror"
                                        id="nama_variasi" name="nama_variasi"
                                        value="{{ old('nama_variasi', $produk->nama_variasi) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('hpp_produk') is-invalid @enderror"
                                        id="hpp_produk" name="hpp_produk"
                                        value="{{ old('hpp_produk', $produk->hpp_produk) }}" min="0" required>
                                    @error('hpp_produk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
