        ...
        <div class="pc-content">
            <div class="card shadow border-0" style="border-radius: 15px; overflow: hidden;">
                <div class="card-header border-0 text-white d-flex justify-content-between align-items-center"
                    ...
                    <h5 class="mb-0 text-white"><i class="fas fa-edit me-2"></i> {{ $is_retur ? 'Edit Retur Supplier' : 'Edit Transaksi Supplier' }}</h5>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="tgl" class="form-control"
                                    value="{{ old('tgl', $supplierTransaction->tgl) }}" required>
                            </div>
                            @if($is_retur)
                            ...
                            @else
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="retur" class="form-control"
                                        value="{{ old('retur', $supplierTransaction->retur) }}" min="0">
                                </div>
                            @endif
                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function initRowEvents(tr) {
                ...
                function updateRow() {
                    ...
                    if (option) {
                        ...
                        if (currentPriceMode === 'default') {
                            // Cek jika ID masih sama dengan saat halaman load, gunakan harga asli
                            ...
                            if (originalId && originalId === barangIdHidden.value) {
                                ...
                                // Jika barang diubah tapi masih mode default, pakai Harga Beli Potong
                    ...
                    calculateTotals();
                    updateDatalistFilter(); // Update datalist agar barang hilang dari opsi lain
                }
                ...
                removeBtn.addEventListener('click', () => { 
                    tr.remove(); 
                    calculateTotals(); 
                    updateDatalistFilter(); // Update agar barang yang dihapus bisa dipilih lagi
                });
            }
